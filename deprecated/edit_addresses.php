...
foreach ($shippingAddresses as $shippingAddress){
  echo "var shippingAddress_".$shippingAddress->id . " = '" . json_encode($shippingAddress) ."';\n";
}
?>
...
function useShippingAddress(id){
    ...
    xx = "shippingAddress_"+id;
    console.log(eval("shippingAddress_"+id));
    let sA = JSON.parse(eval("shippingAddress_"+id));
    parent.onShippingAddressUpdated(id, shipToText, sA.shipTo);
}
