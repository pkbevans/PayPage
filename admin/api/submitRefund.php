...
try {
    ...
    if($result->responseCode == 201){
        if( !$dbResult = insertPayment($incoming->accessToken, "REFUND", $incoming->orderId, $incoming->amount, 0, $incoming->currency,
        ...
        if( !$dbResult = updateOrder($incoming->accessToken, $incoming->orderId, "REFUNDED")){
