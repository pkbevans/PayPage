...
<head>
    ...
    <script type="text/javascript" src="https://h.online-metrix.net/fp/tags.js?org_id=<?php echo $TMOrgId?>&session_id=<?php echo empty(CHILD_MID)?MID:CHILD_MID?><?php echo $sessionId?>"></script>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    ...
    <iframe style="width: 100px;height: 100px;border: 0;position: absolute;top: -5000px;" src="https://h.online-metrix.net/fp/tags?org_id=<?php echo $TMOrgId?>&session_id=<?php echo empty(CHILD_MID)?MID:CHILD_MID?><?php echo $sessionId?>"></iframe>
