                        ...
                        <form onsubmit="return false;">
                                    ...
                                    <div id="cardNumber">
                                        ...
                                        <div class="row mt-3 mb-3">
                                            <div class="col-12">
                                                <label class="form-check-label" for="number-container"><h5>Card Number</h5></label>
                                                <div class="cardInput">
                                    ...
                                    <div class="row">
                                        <div class="col-6" id="cardDate">
                                            <label class="form-check-label" for="expiryDate"><h5>Expiry Date</h5></label>
                                            <div class="cardInput">
                                        ...
                                        <div class="col-6">
                                            <label id="securityCodeLabel" class="form-check-label" for="securityCode-container"><h5>Security Code</h5></label>
                                            <div class="cardInput">
