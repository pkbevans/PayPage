...
function updateAddress(id, setDefaultOnly){
    ...
    $.ajax({
        type: "POST",
        url: "/payPage/admin/api/updateCustomerShippingAddress.php",
        data: JSON.stringify({
...
function deleteAddress(id){
    ...
    $.ajax({
        type: "POST",
        url: "/payPage/admin/api/deleteCustomerShippingAddress.php",
        data: JSON.stringify({
            "customerId": customerId,
            "shippingAddressId": id
        }),
...
function addAddress(){
    ...
    $.ajax({
        type: "POST",
        url: "/payPage/admin/api/addCustomerShippingAddress.php",
        data: JSON.stringify({
            "customerId": customerId,
            "default": defaultAddress,
            "firstName": firstName,
...
function updateCard(id, setDefaultOnly){
    ...
    $.ajax({
        type: "POST",
        url: "/payPage/admin/api/updateCustomerPaymentInstrument.php",
        data: JSON.stringify({
            "setDefaultOnly": setDefaultOnly,
            "customerId": customerId,
...
function addCard(){
    ...
    $.ajax({
        type: "POST",
        url: "/payPage/admin/api/authWithPa.php",
        data: JSON.stringify({
            "order": orderDetails,
            "paAction": "NO_PA",
            "referenceID": "",
...
function deleteCard(id){
    ...
    $.ajax({
        type: "POST",
        url: "/payPage/admin/api/deleteCustomerPaymentInstrument.php",
        data: JSON.stringify({
            "customerId": customerId,
            "paymentInstrumentId": id
        }),
